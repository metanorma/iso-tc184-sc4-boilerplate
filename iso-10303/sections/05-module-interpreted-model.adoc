...
in the AP module, <<module_cover,AP module reference>>, which consists of the mapping
specification and the EXPRESS short form.

The mapping specification found in the AP module, <<module_cover,AP module reference>>,
...
information requirements in the AP module  (<<module_cover,AP module reference>>).
